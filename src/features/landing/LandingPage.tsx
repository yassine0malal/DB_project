                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Link to="/login">
                                    <Button size="lg" variant="outline" className="font-bold text-lg px-8 py-6 border-2 hover:bg-gray-50">
                                        Se connecter
                                    </Button>
                                </Link>
                            </div>
                            <div className="flex items-center gap-8 pt-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-gray-500">Clubs actifs</div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {features.map((feature, index) => (
                            <div key={index} className="group p-6 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300 bg-gradient-to-br from-white to-gray-50">
